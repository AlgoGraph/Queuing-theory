...
describe("DD1K Second case: lambda < mu", () => {
    test("slide 2 page 25", () => {
        ...
        // TODo: Alternating is Not working
        /*
        expect(dd1k.calcNumberOfCustomers(11)).toBe(0);
        expect(dd1k.calcNumberOfCustomers(12)).toBe(1);
        */
