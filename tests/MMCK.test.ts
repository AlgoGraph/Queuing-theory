...
describe("MMC", () => {
    test("slide 6 page 11 ", () => {
        ...
        expect( mmck.calcNumberOfCustomerInTheSystem(0)  - 6.06 ).toBeLessThan(0.01);
        expect( mmck.calcWaitingTimeInTheSystem(0) -12.3  ).toBeLessThan(0.1);
...
describe("MMC", () => {
    test("slide 6 page 15 B/", () => {
        ...
        expect( mmck.calcNumberOfCustomerInTheQueue(0)    ).toBe(0.001);
    });
});